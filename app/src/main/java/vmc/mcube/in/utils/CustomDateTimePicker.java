...
public class CustomDateTimePicker implements View.OnClickListener {
    ...
    public View getDateTimePickerLayout() {
        ...
        button_params.setMargins(5,0,5,5);

        ScrollView scrollView = new ScrollView(activity);
        scrollView.setLayoutParams(linear_match_wrap);
        ...
        btn_setDate.setBackgroundResource(R.drawable.button_background);
        ...
        btn_setTime.setBackgroundResource(R.drawable.button_background);
        ...
        btn_set.setBackgroundResource(R.drawable.button_background);
        btn_set.setText("Set");
        btn_set.setId(SET);
        ...
        btn_cancel.setBackgroundResource(R.drawable.button_background);
        ...
        linear_main.setBackgroundResource(R.color.spinner);
        scrollView.addView(linear_main);
